...
* **🪟 Pro 信息弹窗修复** — 启动提示中的 Pro 功能介绍只显示一次；“了解 Pro 版详情”窗口加宽加高、支持调整大小和内容滚动，避免高 DPI 或小屏幕时信息被截断

**v1.8.8.1 更新：**

* **🛡️ 免费开源提示升级** — 主界面、启动提示、自定义设置和关于窗口明确声明社区版完全免费开源；启动提示在第 1、3、7、10、20 次打开时显示
* **📣 内置 Pro 信息** — 无需联网即可查看 Pro 的红头文件支持、错别字和病句检查、自定义 AI 接入、智能 Agent 助手及购买渠道信息
* **📱 闲鱼二维码显示修复** — 启动提示与 Pro 信息窗口内嵌二维码，并提供可读的店铺按钮和文字备用信息
...
* **🛡️ 社区版官方渠道提示** — 首次启动显示免费声明与官方购买渠道；提示仅本地计数、低频显示，不联网或收集数据

## 社区版与 Pro

您当前使用的是开源社区版（GitHub）。本开源社区版软件完全免费开源，不收取任何费用，无需购买激活码；如有人出售本工具、删除版权声明或捆绑其他程序，请向交易平台举报并要求退款。

Pro 是独立的付费版本，提供更完整的红头文件支持与自定义、错别字和病句检查、自定义 AI 接入、智能 Agent 助手、模板管理、PDF 工具、自动更新、优先问题修复和使用支持；升级完全自愿，不影响开源社区版（GitHub）的基础功能。

当前购买渠道为闲鱼店铺 **Mambo曼波**。抖音、小红书等渠道正在筹备中，最新渠道、价格和 Pro 版本信息均以 [PRO.md](PRO.md) 公示为准。
