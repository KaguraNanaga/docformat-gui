...
您当前使用的是免费开源社区版（GitHub）。从 `v1.8.8.3` 起，本版本依据 [PolyForm Noncommercial License 1.0.0](LICENSE) 提供，仅限个人和非商业用途免费使用；未经许可，不得销售、收费分发或用于其他商业目的。

Pro 是独立的付费版本，提供更完整的红头文件支持与自定义、错别字和病句检查、自定义 AI 接入、智能 Agent 助手、模板管理、PDF 工具、自动更新、优先问题修复和使用支持；升级完全自愿，不影响免费开源社区版（GitHub）在许可证允许范围内的基础功能。
